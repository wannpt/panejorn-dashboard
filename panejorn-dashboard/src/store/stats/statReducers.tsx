			...
			if (action.payload === 'เชียงใหม่') {
				result = {
					...
					provinceDetails: [
						{
							place: 'เวียงกุมกาม',
							number_of_people: '3,774',
							budget: '338,700',
						},
						{
							place: 'สวนสัตว์เชียงใหม่',
							number_of_people: '3,129',
							budget: '316,450',
						},
						{
							place: 'อุทยานแห่งชาติดอยอินทนนท์',
							number_of_people: '3,071',
							budget: '297,420',
						},
						{
							place: 'อุทยานแห่งชาติดอยสุเทพ',
							number_of_people: '2,861',
							budget: '167,280',
						},
						{
							place: 'ศูนย์การค้าเมญ่า',
							number_of_people: '2,511',
							budget: '160,220',
						},
						{
							place: 'สวนราชพฤกษ์',
							number_of_people: '2,321',
							budget: '107,080',
						},
					],
				};
